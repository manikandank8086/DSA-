...
console.log("Search 'apple' in trie:", trie.search("apple")); // Output: true
console.log("Search 'app' in trie:", trie.search("app")); // Output: false (Prefix exists, but not a complete word)
